...
<div class="row">
    <div  class="col-md-4 col-md-offset-4">
        ...
        <div class="content_div">
            ...
            <label>{{tab_lang.inscription.nom}} : </label><br/><input type="text" name="nom" class="form-control" value=""/><br />
            <label>{{tab_lang.inscription.prenom}} : </label><br/><input type="text" name="prenom" class="form-control" value=""/><br />
            <label>{{tab_lang.inscription.email}} : </label><br/><input type="text" name="email" class="form-control" value=""/><br />
