                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="${pageContext.servletContext.contextPath}/ListeAlbums?idUtilisateurAAfficher=${c.auteur.id}">
                                            <img src="${pageContext.servletContext.contextPath}/profil/${c.auteur.imageProfil}" class="img-rounded img-responsive imageProfilCommentaire" alt="" />
                                        </a>
                                    </div>
                                    <div class="col-md-10">
...
<div class="row decale">
    <div class="col-md-6">
        <form method="POST" action="${pageContext.servletContext.contextPath}/Album">
            <input type="text" name="commentaire" id="commentaire"  maxlength="200" class="form-control" placeholder="{{tab_lang.album.posterCommentaire}}" required/>
